  ...
  return (
    <section className="bg-dark xl:pt-10">
      <div className="relative pb-9 xl:pb-16 h-full items-center justify-center rounded-b-[5%] bg-dark2">
        <div className="max-w-[90%] text-center h-[400px] flex justify-center mx-auto px-1 xl:pt-6 items-center  pt-28">
          {/* Background Image */}
          <img
            src={BackgroundImg}
            alt="Underline Effect"
            className="absolute w-auto h-auto top-[66%] md:top-[70%] xl:top-[60%] 
              left-1/2 
              transform 
              -translate-x-1/2 
              -translate-y-[70%]  /* Adjust this value to align with the text */
              sm:w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] 
