  ...
  return (
    <section>
      <div className=" bg-dark">
        <div className="max-w-[85%] mx-auto px-1 pt-16 xl:pt-20 flex flex-col-reverse items-center xl:grid xl:grid-cols-2 h-full max-w gap-x-10 mb-12 justify-center">
          ...
          <div className="flex flex-col xl:pl-44 justify-center h-full md:grid md:basis-2/3 text-dark">
            ...
            <h1 className="text-5xl xl:text-7xl font-normal mb-4 xl:mr-20 text-white">
